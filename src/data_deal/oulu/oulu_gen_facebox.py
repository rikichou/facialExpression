...
IMG_ROOT_DIR = '/train_tmp/fer/select/finish2/Oulu_CASIA_NIR_VIS/train'
...
for subdir in subdirs:
    ...
    for idx,img in enumerate(imgs):
        ...
        # cv2.waitKey(0)
    total_noface_count += noface_count
    print("{} : {} have no face!".format(subdir, noface_count))
    noface_count = 0
print("{} have no face!".format(total_noface_count))