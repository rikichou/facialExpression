...
def test_video(video_path, args):
    ...
    fer_mmcls = mmcls_fer.MMCLSFer(config_file_path='../data_deal/common_utils/mmcls_python/models/resnet_18_dms_rgbnir/resnet_18_dms_rgbnir.py',
                                   ckpt_path='../data_deal/common_utils/mmcls_python/models/resnet_18_dms_rgbnir/epoch_16.pth',
                                   device='cpu' if args.cpu else 'cuda')
...
VIDEO_PATH = '/Users/zhourui/Downloads/0000000000000000-210917-184530-184611-000001000010.mp4'
